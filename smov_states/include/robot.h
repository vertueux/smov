...
#include "smov_msgs/msg/display_text.hpp"
...
struct RobotData {
  ...
  static int front_board_i2c_bus;
  static int back_board_i2c_bus;
  ...
  smov_msgs::msg::DisplayText up_display;
...
class RobotNodeHandle : public rclcpp::Node {
 public:
  ...
  void end_state_callback(smov_msgs::msg::EndState::SharedPtr msg);
  ...
  rclcpp::Subscription<smov_msgs::msg::StatesServos>::SharedPtr front_states_sub;
  rclcpp::Subscription<smov_msgs::msg::StatesServos>::SharedPtr back_states_sub;

  rclcpp::Subscription<smov_msgs::msg::EndState>::SharedPtr end_state_sub;

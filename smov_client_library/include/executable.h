...
#define STATE_CLASS(name) void on_start();\
                          ...
                          smov_msgs::msg::StatesServos front_servos;\
                          smov_msgs::msg::StatesServos back_servos;\
                          smov_msgs::msg::EndState end_state;\
                          ...
                          rclcpp::Publisher<smov_msgs::msg::EndState>::SharedPtr end_state_publisher;\
   ...
   public:\
    ...
    : Node(node_name), count(0) {\
      ...
      state.front_state_publisher =\
        this->create_publisher<smov_msgs::msg::StatesServos>("front_proportional_servos", 50);\
      state.back_state_publisher =\
        this->create_publisher<smov_msgs::msg::StatesServos>("back_proportional_servos", 50);\
      state.end_state_publisher =\
        this->create_publisher<smov_msgs::msg::EndState>("end_state", 1);\

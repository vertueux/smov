...
#define STATE_CLASS(name) void on_start();\
                          ...
                          i2c_pwm_board_msgs::msg::StatesServos front_servos;\
                          i2c_pwm_board_msgs::msg::StatesServos back_servos;\
                          i2c_pwm_board_msgs::msg::EndState end_state;\
                          rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr front_state_publisher;\
                          rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr back_state_publisher;\
                          rclcpp::Publisher<i2c_pwm_board_msgs::msg::EndState>::SharedPtr end_state_publisher;\

#define STATE_LIBRARY_CLASS(name) i2c_pwm_board_msgs::msg::StatesServos* front_servos;\
                                  i2c_pwm_board_msgs::msg::StatesServos* back_servos;\
                                  void delay(int time) {struct timespec ts = {0,0}; ts.tv_sec = time / 1000; ts.tv_nsec = (time % 1000) * 1000000; nanosleep(&ts, NULL);}\
                                  rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr* front_state_publisher;\
                                  rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr* back_state_publisher;\
                                  name(i2c_pwm_board_msgs::msg::StatesServos* f_servos, i2c_pwm_board_msgs::msg::StatesServos* b_servos,\
                                   rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr* f_pub,\
                                   rclcpp::Publisher<i2c_pwm_board_msgs::msg::StatesServos>::SharedPtr* b_pub)\
   ...
   public:\
    ...
    : Node(node_name), count(0) {\
      ...
      state.front_state_publisher =\
        this->create_publisher<i2c_pwm_board_msgs::msg::StatesServos>("front_proportional_servos", 50);\
      state.back_state_publisher =\
        this->create_publisher<i2c_pwm_board_msgs::msg::StatesServos>("back_proportional_servos", 50);\
      state.end_state_publisher =\
        this->create_publisher<i2c_pwm_board_msgs::msg::EndState>("end_state", 1);\

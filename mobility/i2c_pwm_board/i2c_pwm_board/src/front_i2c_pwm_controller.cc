...
#include "front_i2c_pwm_board_msgs/msg/servo_config.hpp"
#include "front_i2c_pwm_board_msgs/msg/servo_config_array.hpp"

// Request/response of the servo setup service.
#include "front_i2c_pwm_board_msgs/srv/servos_config.hpp"

// request/response of the drive mode service.
#include "front_i2c_pwm_board_msgs/srv/drive_mode.hpp"
#include "front_i2c_pwm_board_msgs/msg/position.hpp"
#include "front_i2c_pwm_board_msgs/msg/position_array.hpp"

// Request/response of the integer parameter services.
#include "front_i2c_pwm_board_msgs/srv/int_value.hpp"
...
void servos_absolute (const std::shared_ptr<front_i2c_pwm_board_msgs::msg::ServoArray> msg) {
  /* This subscription works on the active_board. */
  for (std::vector<front_i2c_pwm_board_msgs::msg::Servo>::const_iterator sp = msg->servos.begin(); sp != msg->servos.end(); ++sp) {
    int servo = sp->servo;
    int value = sp->value;
...
void servos_proportional (const std::shared_ptr<front_i2c_pwm_board_msgs::msg::ServoArray> msg) {
  /* This subscription works on the active_board. */
...
bool set_pwm_frequency (const std::shared_ptr<front_i2c_pwm_board_msgs::srv::IntValue::Request> req, std::shared_ptr<front_i2c_pwm_board_msgs::srv::IntValue::Response> res) {
  int freq;
  freq = req->value;
...
bool config_servos (const std::shared_ptr<front_i2c_pwm_board_msgs::srv::ServosConfig::Request> req, std::shared_ptr<front_i2c_pwm_board_msgs::srv::ServosConfig::Response> res) {
...
bool config_drive_mode (const std::shared_ptr<front_i2c_pwm_board_msgs::srv::DriveMode::Request> req, std::shared_ptr<front_i2c_pwm_board_msgs::srv::DriveMode::Response> res) {
  res->error = 0;
...
int main (int argc, char **argv) {	
	...
	rclcpp::Service<front_i2c_pwm_board_msgs::srv::IntValue>::SharedPtr freq_srv         = node->create_service<front_i2c_pwm_board_msgs::srv::IntValue>("set_pwm_frequency", &set_pwm_frequency);
	rclcpp::Service<front_i2c_pwm_board_msgs::srv::ServosConfig>::SharedPtr config_srv   =	node->create_service<front_i2c_pwm_board_msgs::srv::ServosConfig>("config_servos", &config_servos);			// 'config' will setup the necessary properties of continuous servos and is helpful for standard servos
	rclcpp::Service<front_i2c_pwm_board_msgs::srv::DriveMode>::SharedPtr mode_srv        =	node->create_service<front_i2c_pwm_board_msgs::srv::DriveMode>("config_drive_mode", &config_drive_mode);		// 'mode' specifies which servos are used for motion and which behavior will be applied when driving
	...
	rclcpp::Subscription<front_i2c_pwm_board_msgs::msg::ServoArray>::SharedPtr abs_sub   = node->create_subscription<front_i2c_pwm_board_msgs::msg::ServoArray>("servos_absolute", 500, &servos_absolute);		// the 'absolute' topic will be used for standard servo motion and testing of continuous servos
	rclcpp::Subscription<front_i2c_pwm_board_msgs::msg::ServoArray>::SharedPtr rel_sub   = node->create_subscription<front_i2c_pwm_board_msgs::msg::ServoArray>("servos_proportional", 500, &servos_proportional);	// the 'proportion' topic will be used for standard servos and continuous rotation aka drive servos

...
#include "back_i2c_pwm_board_msgs/msg/servo.hpp"
#include "back_i2c_pwm_board_msgs/msg/servo_array.hpp"

// Messages used for the servo setup service.
#include "back_i2c_pwm_board_msgs/msg/servo_config.hpp"
#include "back_i2c_pwm_board_msgs/msg/servo_config_array.hpp"

// Request/response of the servo setup service.
#include "back_i2c_pwm_board_msgs/srv/servos_config.hpp"

// request/response of the drive mode service.
#include "back_i2c_pwm_board_msgs/srv/drive_mode.hpp"
#include "back_i2c_pwm_board_msgs/msg/position.hpp"
#include "back_i2c_pwm_board_msgs/msg/position_array.hpp"

// Request/response of the integer parameter services.
#include "back_i2c_pwm_board_msgs/srv/int_value.hpp"

// The class that handles messages between the controller and ROS2.
class I2CPWMNode : public rclcpp::Node {
public:
    explicit I2CPWMNode(const std::string & node_name="back_i2c_pwm_controller", const std::string & node_namespace="/")
...
void servos_absolute (const std::shared_ptr<back_i2c_pwm_board_msgs::msg::ServoArray> msg) {
  /* This subscription works on the active_board. */
  for (std::vector<back_i2c_pwm_board_msgs::msg::Servo>::const_iterator sp = msg->servos.begin(); sp != msg->servos.end(); ++sp) {
    int servo = sp->servo;
    int value = sp->value;
...
void servos_proportional (const std::shared_ptr<back_i2c_pwm_board_msgs::msg::ServoArray> msg) {
  /* This subscription works on the active_board. */
...
bool set_pwm_frequency (const std::shared_ptr<back_i2c_pwm_board_msgs::srv::IntValue::Request> req, std::shared_ptr<back_i2c_pwm_board_msgs::srv::IntValue::Response> res) {
  int freq;
  freq = req->value;
...
bool config_servos (const std::shared_ptr<back_i2c_pwm_board_msgs::srv::ServosConfig::Request> req, std::shared_ptr<back_i2c_pwm_board_msgs::srv::ServosConfig::Response> res) {
...
bool config_drive_mode (const std::shared_ptr<back_i2c_pwm_board_msgs::srv::DriveMode::Request> req, std::shared_ptr<back_i2c_pwm_board_msgs::srv::DriveMode::Response> res) {
  res->error = 0;
...
int main (int argc, char **argv) {	
	...
	rclcpp::Service<back_i2c_pwm_board_msgs::srv::IntValue>::SharedPtr freq_srv         = node->create_service<back_i2c_pwm_board_msgs::srv::IntValue>("set_pwm_frequency", &set_pwm_frequency);
	rclcpp::Service<back_i2c_pwm_board_msgs::srv::ServosConfig>::SharedPtr config_srv   =	node->create_service<back_i2c_pwm_board_msgs::srv::ServosConfig>("config_servos", &config_servos);			// 'config' will setup the necessary properties of continuous servos and is helpful for standard servos
	rclcpp::Service<back_i2c_pwm_board_msgs::srv::DriveMode>::SharedPtr mode_srv        =	node->create_service<back_i2c_pwm_board_msgs::srv::DriveMode>("config_drive_mode", &config_drive_mode);		// 'mode' specifies which servos are used for motion and which behavior will be applied when driving
	...
	rclcpp::Subscription<back_i2c_pwm_board_msgs::msg::ServoArray>::SharedPtr abs_sub   = node->create_subscription<back_i2c_pwm_board_msgs::msg::ServoArray>("servos_absolute", 500, &servos_absolute);		// the 'absolute' topic will be used for standard servo motion and testing of continuous servos
	rclcpp::Subscription<back_i2c_pwm_board_msgs::msg::ServoArray>::SharedPtr rel_sub   = node->create_subscription<back_i2c_pwm_board_msgs::msg::ServoArray>("servos_proportional", 500, &servos_proportional);	// the 'proportion' topic will be used for standard servos and continuous rotation aka drive servos
